 ...
 */
public class StoreTables implements HBAction {
    ...
    public void action(HB hb) {
        ...
        TextControl storedTable = new TextControlSender(this, "Stored Table", "data/tables/Acrux.txt");


        new TriggerControl(this, "Load Acrux") {
            @Override
        ...
        TriggerControl loadTable = new TriggerControl(this, "Save Acrux") {
            @Override
            public void triggerEvent() {// Write your DynamicControl code below this line
                ...
                OSCMessage msg = OSCMessageBuilder.createOscMessage(commandLoader.buildOscName(StellarOSCVocabulary.CommandMessages.SAVE_TABLE), file_path);
