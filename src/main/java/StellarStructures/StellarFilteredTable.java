...
public class StellarFilteredTable {
     ...
     * @return the sort type we are using
     */
     ...
     * @return min altitude  for this field of view
     */
     ...
     * @return the maximum altitude for this field of view
     */
    ...
    public int  buildTable(int max_stars){
        ...
        // Calculate our Max and Min Sizes
