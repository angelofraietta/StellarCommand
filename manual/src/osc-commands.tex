...
\subsection{poll} \index{OSC messages to Stellar Command!poll}
...
\subsection{azimuth} \index{OSC messages to Stellar Command!azimuth}
...
\subsection{timeRate}\index{OSC messages to Stellar Command!timeRate}
